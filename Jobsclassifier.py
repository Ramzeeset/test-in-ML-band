...
class Jobsclassifier:
    ...
    def fit(self, data):
        ...
        big = self.calculation_tfidf(data)
        best = {'Менеджер': {}, 'Искусство': {}, 'Рабочий': {}, 'Дизайнер': {},
                'Специалист': {}, 'СМИ': {}, 'Врач': {}, 'other': {}, 'Инженер': {},
                'IT': {}, 'Право': {}, 'Учитель': {}, 'Агент': {}
                }
    ...
    def predict(self, data):
        ...
        pred = []
        category = ['Менеджер', 'Искусство', 'Рабочий','Дизайнер', 
                    'Специалист','СМИ', 'Врач', 'other', 'Инженер', 
                    'IT', 'Право', 'Учитель', 'Агент'
                    ]
        ...
        for i in range(0, len(data)):
            ...
            for word in self.description_processing(data[i]):
